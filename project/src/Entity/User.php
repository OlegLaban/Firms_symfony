...
class User extends BaseUser
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Companies", inversedBy="employee")
    ...
    public function setBirthDay(Object $birthDay): self
    {
    ...
    {
        $age = time() - strtotime($this->getBirthDay()->date);
        return round($age/31556926, 0, PHP_ROUND_HALF_DOWN);
    }
